        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/70 backdrop-blur-sm border border-white/20 shadow-lg">
              ...
              <span className="text-sm font-medium text-slate-700">Professional Support Available</span>
            </div>
            
            <h1 className="text-5xl md:text-6xl font-black bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent leading-tight">
              Get in Touch
            </h1>
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto font-light leading-relaxed">
              ...
              <span className="font-semibold text-blue-600"> medical journey</span> in Nepal
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mt-12">
              {stats.map((stat, index) => (
                <div key={index} className="group">
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="space-y-2">
                    {info.details.map((detail, idx) => (
                      <div key={idx} className="flex items-start space-x-2">
                        ...
                        <p className="text-slate-700 text-sm break-words">{detail}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="relative bg-gradient-to-br from-slate-100 to-blue-100 rounded-2xl overflow-hidden shadow-2xl border border-white/20 group">
                ...
                <div className="relative h-80 flex items-center justify-center">
                  <div className="text-center space-y-4">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-xl group-hover:scale-110 transition-transform duration-300">
                      <MapPin className="h-8 w-8" />
                    </div>
                    <div>
                      <p className="text-slate-700 font-semibold">Interactive Map</p>
                      <p className="text-slate-500 text-sm">Google Maps integration available</p>
                    </div>
                  </div>
                </div>
