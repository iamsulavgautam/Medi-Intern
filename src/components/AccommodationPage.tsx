  ...
  const accommodations = [
    {
      ...
      description:
        "Purpose-built accommodation for medical interns, fostering community and collaboration.",
    },
    {
      ...
      description:
        "Live with carefully selected Nepali families for authentic cultural experience.",
    },
    {
      ...
      description:
        "Modern, comfortable apartments for interns preferring privacy and independence.",
    },
    {
      ...
      description:
        "Comfortable hotel accommodation for short-term programs or luxury preferences.",
    },
  ];
  ...
  const amenities = [
    {
      ...
      description:
        "Reliable Wi-Fi for research, communication with family, and online learning.",
    },
    {
      icon: <Shield className="h-8 w-8" />,
      title: "24/7 Security",
      description:
        "Round-the-clock security personnel and secure access systems.",
    },
    {
      icon: <Car className="h-8 w-8" />,
      title: "Transportation",
      description:
        "Daily shuttle service to hospitals and major city locations.",
    },
    {
      icon: <Utensils className="h-8 w-8" />,
      title: "Meal Options",
      description:
        "Various dining options including local cuisine and international food.",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto font-light leading-relaxed">
              Comfortable, safe, and convenient housing options designed
              specifically for
              <span className="font-semibold text-white">
                {" "}
                international medical interns
              </span>
              .
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              We offer various housing options to suit different preferences,
              budgets, and program durations.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Essential services and facilities included with all accommodation
              options.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      All accommodations are within 15 minutes of partner
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      24/7 security, emergency contacts, and regular safety
                      briefings for all interns.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Regular inspections and intern feedback ensure high
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Select the housing option that best fits your preferences and
                budget.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Complete the housing application with your program dates and
                preferences.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Get accommodation confirmation with detailed information and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Arrive and settle into your new home with assistance from our
                support team.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
              Book early to ensure availability and get the best rates for your
