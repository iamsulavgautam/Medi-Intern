...
const PhysiotherapyInternshipPage: React.FC<
  PhysiotherapyInternshipPageProps
> = ({ setCurrentPage }) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-emerald-100 mb-8">
                Specialized physiotherapy training focusing on rehabilitation
                techniques, therapeutic exercises, and patient care in various
                clinical settings across Nepal's leading rehabilitation centers.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <div className="prose prose-lg text-gray-600 space-y-6">
                <p>
                  Our Physiotherapy Internship program offers comprehensive
                  hands-on training in rehabilitation medicine and therapeutic
                  interventions. Students work alongside experienced
                  physiotherapists in Nepal's premier rehabilitation centers,
                  gaining exposure to diverse patient populations and treatment
                  modalities.
                </p>
                <p>
                  The program covers musculoskeletal, neurological,
                  cardiopulmonary, and pediatric physiotherapy, providing a
                  well-rounded clinical experience. Interns participate in
                  patient assessments, treatment planning, therapeutic
                  interventions, and outcome evaluations.
                </p>
                <p>
                  Nepal's unique healthcare challenges provide excellent
                  learning opportunities in resource-adapted rehabilitation
                  techniques and community-based physiotherapy approaches that
                  are increasingly relevant in global healthcare settings.
                </p>
              </div>
            </div>
              ...
              >
                <div>
                  ...
                  <p className="text-teal-600 font-bold">
                    450 USD (Paid at the time of submission of application)
                  </p>
                </div>
              ...
              {expandedSection === "registration" && (
                <div className="mt-4 text-gray-600 space-y-2">
                  ...
                  <ul className="list-decimal list-inside space-y-1">
                    <li>
                      Registration fee would guarantee your spot in your desired
                      department at the hospital.
                    </li>
                    <li>
                      Confirm your first-day orientation at the hospital with
                      the faculty member.
                    </li>
                    <li>
                      Your application will be processed, and you will receive
                      the approval letter.
                    </li>
                    <li>
                      Support you with onboarding and assist you with your
              ...
              {expandedSection === "hospital" && (
                <div className="mt-4 text-gray-600 space-y-4">
                  {renderFeeTable(
                    ...
                    [200, 200, 250, 300, 350, 50],
                    "Fee"
                  )}
                  <div>
                    <h4 className="font-semibold mt-4">
                      What’s Included in Hospital Registration Fee.
                    </h4>
                    <ul className="list-decimal list-inside space-y-1">
                      <li>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-600">
                    Comprehensive patient assessment and evaluation techniques
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Evidence-based treatment planning and goal setting
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Use of physiotherapy equipment and modalities
                  </span>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Resource-adapted rehabilitation approaches
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-emerald-500 mt-0.5 flex-shrink-0" />
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-600">
                    Currently enrolled in physiotherapy program
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Completed basic physiotherapy sciences
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Minimum 2nd year physiotherapy student
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Physical fitness for clinical work
                  </span>
                </li>
              </ul>
            </div>
