...
const DentalElectivePage: React.FC<DentalElectivePageProps> = ({
  setCurrentPage,
}) => {
              ...
              >
                <div>
                  ...
                  <p className="text-teal-600 font-bold">
                    For the first two weeks, that is 200 USD, and 50 USD will be
                    added each week after the two weeks.
                  </p>
                </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Completed basic dental sciences
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-600">
                    Minimum 3rd year dental student
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
      ...
      <section className="py-20 bg-gradient-to-r from-teal-600 to-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Start Your Dental Elective?
          </h2>
          <p className="text-xl mb-8 text-teal-100">
            Join our comprehensive dental program and gain invaluable clinical
            experience in Nepal.
          </p>
