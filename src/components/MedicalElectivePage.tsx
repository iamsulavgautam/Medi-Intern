...
import { ArrowLeft, Clock, Users, MapPin, CheckCircle, Star, Heart, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    return (
        <div className="py-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-blue-100 mb-8">
                                Comprehensive medical elective program covering multiple specialties including internal medicine, surgery, pediatrics, and emergency medicine in Nepal's premier teaching hospitals.
                            </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        <div className="lg:col-span-2">
                            ...
                            <div className="prose prose-lg text-gray-600 space-y-6">
                                <p>
                                    Our Medical Elective program offers the most comprehensive clinical experience available to international
                                    medical students in Nepal. This flagship program provides rotations across multiple medical specialties,
                                    allowing students to gain broad exposure to various aspects of healthcare delivery.
                                </p>
                                <p>
                                    Students work directly with patients under the supervision of experienced physicians, participate in
                                    ward rounds, attend clinical conferences, and engage in medical research projects. The program is
                                    designed to enhance clinical reasoning, diagnostic skills, and patient management capabilities.
                                </p>
                                <p>
                                    Nepal's diverse patient population and unique disease patterns provide exceptional learning opportunities,
                                    including exposure to tropical diseases, high-altitude medicine, and resource-limited healthcare settings
                                    that prepare students for global medical practice.
                                </p>
                            </div>
                        </div>
                   ...
                   <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                     ...
                     <div className="space-y-6">
                         ...
                         {expandedSection === 'registration' && (
                           <div className="mt-4 text-gray-600 space-y-2">
                             ...
                             <ul className="list-decimal list-inside space-y-1">
                               <li>Book placement dates for your desired specialities and departments.</li>
                               <li>Book your first-day orientation with the faculty.</li>
                               <li>Provide you with an approval letter with details of the department and supervisor.</li>
                               <li>Assist you with onboarding and filling in the required university documents.</li>
                             </ul>
                           </div>
                         )}
                       </div>
                       ...
                       <div className="bg-white rounded-lg shadow p-6">
                         ...
                         >
                           <div>
                             <h3 className="text-xl font-semibold text-gray-900">Elective Fee</h3>
                             <p className="text-teal-600 font-bold">300 USD for one week</p>
                           </div>
                         ...
                         {expandedSection === 'hospital' && (
                           <div className="mt-4 text-gray-600 space-y-4">
                             {renderFeeTable('Hospital Registration', [300, 300, 375, 450, 525, 75], 'Fee')}
                             <div>
                               <h4 className="font-semibold mt-4">What’s Included in Elective Fee.</h4>
                               <ul className="list-decimal list-inside space-y-1">
            ...
            <section className="py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Medical Specialties</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                            <div className="bg-blue-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                                <Heart className="h-6 w-6 text-blue-600" />
                            </div>
                            <h3 className="text-xl font-semibold text-gray-900 mb-4">Internal Medicine</h3>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-4">Surgery</h3>
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-start space-x-2">
                                    <CheckCircle className="h-4 w-4 text-green-500 mt-1 flex-shrink-0" />
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-4">Pediatrics</h3>
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-start space-x-2">
                                    <CheckCircle className="h-4 w-4 text-green-500 mt-1 flex-shrink-0" />
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-4">Obstetrics & Gynecology</h3>
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-start space-x-2">
                                    <CheckCircle className="h-4 w-4 text-green-500 mt-1 flex-shrink-0" />
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-4">Community Medicine</h3>
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-start space-x-2">
                                    <CheckCircle className="h-4 w-4 text-green-500 mt-1 flex-shrink-0" />
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Learning Objectives</h2>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start space-x-3">
                                    ...
                                    <span className="text-gray-600">Advanced history taking and physical examination skills</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Clinical reasoning and differential diagnosis development</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Patient management and treatment planning</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Interpretation of diagnostic tests and imaging</span>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Effective communication with patients and families</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Interdisciplinary healthcare team collaboration</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Cultural sensitivity and global health awareness</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-blue-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Medical ethics and professionalism</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li className="flex items-start space-x-3">
                                    ...
                                    <span className="text-gray-600">Currently enrolled in medical school</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Completed basic clinical rotations</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Minimum 3rd year medical student</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">Good academic standing (GPA 3.0+)</span>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-3">
                                ...
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-600">English proficiency (IELTS 6.5+)</span>
                                </li>
                                <li className="flex items-start space-x-3">
                                    <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <blockquote className="text-xl italic text-gray-700 mb-6">
                            "The medical elective program was the highlight of my medical education. The diversity of cases,
                            the mentorship from local physicians, and the cultural immersion created an unparalleled learning
                            experience that has shaped my approach to medicine."
                        </blockquote>
            ...
            <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-4xl font-bold mb-6">Ready to Begin Your Medical Elective?</h2>
                    <p className="text-xl mb-8 text-blue-100">
                        Join our flagship medical program and gain comprehensive clinical experience in Nepal.
                    </p>
