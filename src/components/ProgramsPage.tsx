        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto font-light leading-relaxed">
              ...
              gain invaluable experience in Nepal's healthcare system.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {programs.map((program, index) => (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-white/20 transform hover:-translate-y-1"
              >
                <img
                  src={program.image}
                  alt={program.title}
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={() =>
                        setCurrentPage && setCurrentPage("application")
                      }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600">
              Comprehensive support and resources for your medical internship
              experience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-slate-600">
                Dedicated medical supervisor and peer support throughout your
                program.
              </p>
            </div>
            ...
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-slate-600">
                Official completion certificate recognized by international
                medical boards.
              </p>
            </div>
            ...
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-slate-600">
                Organized cultural excursions and language learning
                opportunities.
              </p>
            </div>
            ...
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-slate-600">
                Round-the-clock assistance for medical and personal emergencies.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
              Join our programs and gain the experience that will shape your
              medical career.
            </p>
            <button
